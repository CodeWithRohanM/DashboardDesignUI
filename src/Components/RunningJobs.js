...
const RunningJobs = () => {
    ...
    return <>
        ...
        <div className="flex w-[634px] h-[208px] mt-[152px] ml-[296px] absolute">

            <div className="w-full h-full flex rounded-[16px] border-[#D9DCDF] border-[1px] relative bg-white">

                <h1 className="mt-[24px] ml-[16px] text-[#011627] text-[20px] font-semibold tracking-wide">Running Jobs</h1>
